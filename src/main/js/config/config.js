...
const ARTIST_INFO_URL = "api/getArtistInfo";
const ALBUM_INFO_URL = "api/getAlbumInfo";
...
const ADD_ARTIST_TO_COLLECTION_URL = "api/secured/addArtistToCollection";
